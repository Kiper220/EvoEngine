...
namespace RTL::Types{
    ...
    void Directory::operator=(const String& string){
    ...
    void Directory::operator=(const Directory& directory){
        this->_EntityName = directory._EntityName;
        this->_EntityFullPath = directory._EntityFullPath;
        this->_EntityType = FSEntityType::Directory;
    }
    ...
    /// TODO: Make Normal FSEntity Return
    FSEntity* Directory::operator[](const String& string){
        FSEntity* pFsEntity;
        if(this->DirectoryEntities.GetOnly(string, (FSEntity**)&pFsEntity))
            return pFsEntity;
        return this;
    }

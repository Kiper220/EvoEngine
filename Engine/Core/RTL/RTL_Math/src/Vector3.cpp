...
#include "RTL/Math/Vector3.h"
#include "RTL/Math/Quaternion.h"
#include <cmath>
#include <iostream>
...
namespace RTL::Math {
    ...
    Vector3::operator String(){
        return String("X: ") + std::to_string(this->x) + String(", Y: ") + std::to_string(this->y) + String(", Z: ") + std::to_string(this->z) + ";";
    }
